  ...
  pw.Widget _itemsTable(List<BillItem> items) {
    ...
    return pw.TableHelper.fromTextArray(
      ...
      columnWidths: {
        ...
        11: const pw.FlexColumnWidth(1.15),
      },
    ...
    return pw.Row(
      ...
      children: [
        pw.Container(
          ...
          child: pw.Column(
            children: [
              if (bill.items.any((i) => i.discount > 0)) ...[
                _totalRow(
                  'Gross',
                  _money(
                    bill.items.fold<double>(0, (s, i) => s + i.grossAmount),
                  ),
                ),
                _totalRow(
                  'Discount',
                  '- ${_money(bill.items.fold<double>(0, (s, i) => s + i.discount))}',
                ),
                _totalRow('Taxable', _money(bill.subtotal)),
              ] else
              ...
              _totalRow('Paid', _money(bill.paidAmount)),
              _totalRow('Remaining', _money(bill.remainingAmount)),
            ],
          ),
        ),
      ],
